...
public class InformationQoIType extends com.altova.xml.TypeBase
{
	public static com.altova.xml.meta.ComplexType getStaticInfo() { return new com.altova.xml.meta.ComplexType(com.MetaData.MetaData_TypeInfo.binder.getTypes()[com.MetaData.MetaData_TypeInfo._altova_ti_altova_InformationQoIType]); }
	
	public InformationQoIType(org.w3c.dom.Node init)
	{
		super(init);
		instantiateMembers();
	}
	...
	{
		id = new MemberAttribute_id (this, com.MetaData.MetaData_TypeInfo.binder.getMembers()[com.MetaData.MetaData_TypeInfo._altova_mi_altova_InformationQoIType._id]);

		QoIBaseAttr= new MemberElement_QoIBaseAttr (this, com.MetaData.MetaData_TypeInfo.binder.getMembers()[com.MetaData.MetaData_TypeInfo._altova_mi_altova_InformationQoIType._QoIBaseAttr]);
	}
	// Attributes
